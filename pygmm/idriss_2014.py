...
class Idriss2014(model.Model):
    """Idriss (2014) ground motion model.

    Citation:
        Idriss, I. M. (2014). An NGA-West2 Empirical Model for Estimating the
        Horizontal Spectral Value Generated by Shallow Crustal Earthquakes.
    ...
    def __init__(self, **kwds):
        """Compute the response predicted the Idriss (2014) ground
        motion model.
        ...
        Inputs:
            ...
            mechanism: str, default: 'SS'
                fault mechanism. The following mechanisms are possible:

                    +--------------+-----------------+
                    | Abbreviation | Fault Mechanism |
                    +==============+=================+
                    | SS           | Strike Slip     |
                    +--------------+-----------------+
                    | RS           | Reverse Slip    |
