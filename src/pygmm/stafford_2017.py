...
class Stafford2017:
    ...
    def compute_variances(cls, frequencies):
        def compute_sigma_E(f):
            ...
            return sigma_E0 + S(f, sigma_E1, sigma_E2, sigma_E3) + S(f, sigma_E4, sigma_E5, sigma_E6)
        ...
        def compute_sigma_S(f):
            ...
            return sigma_S0 + S(f, sigma_S1, sigma_S2, sigma_S3) + S(f, sigma_S4, sigma_S5, sigma_S6)
